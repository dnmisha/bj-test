...
<form id="formNewTask" name="new-task" method="post" class="form-horizontal">
                ...
                <div class="col-lg-4">
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" required id="user_name" name="user_name" value="<?=htmlspecialchars($task->user_name);?>"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="email" class="form-control" required id="email" name="email" value="<?=htmlspecialchars($task->email);?>"
                        ...
                        <div class="col-sm-10">
                            ...
                            <select name="status" id="statusFilter">
                                <?php foreach ( Task::getStatusName() as $key=>$option): ?>
                                    <option <?=($key==$task->status)?'selected':''?> value="<?=$key;?>"><?=$option;?></option>
                                <?php endforeach; ?>
                            </select>
                        </div>
                    </div>
